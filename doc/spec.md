...
Ideal for writing big as well as small programs, since every heavyweight feature has a lightweight counterpart, it integrates state-of-the-art advancements in the programming language field together with a number of novel bits invented or reinterpreted by me throughout more than 15 years of passion, research and work.

Among the highlights: type and kind inference, System-F types and first-class polymorphism, open-world context-independent overloading with automatic as well as semi-automatic resolution, constrained parametric polymorphism, implicit parameters, union types supporting fully-inferred Generalized Algebraic Datatypes, row types for polymorphic variants and records, overloadable data constructors and  overloadable record labels supporting structual subtype polymorphism, powerful kind system supporting higher-order polymorphism, kind polymorphism, value-to-type & type-to-kind promotion and demotion, first-class modules and much more.
